...
function interact() {
	...
	if clownNose and global.clownNose == true {
		if !saidThanks {
			...
			textbox true
			g [typistSoundPerChar,snd_gordontalk,.9,1]Aw, thanks bro.
			textbox false
			";
			...
			textbox true
			g [typistSoundPerChar,snd_gordontalk,.9,1]Alright you can go now.
			textbox false
			";
		}
	} else {
		...
		textbox true
		g [typistSoundPerChar,snd_gordontalk,.9,1]Greetmigs.
		slide Gordon 0 0
		g [typistSoundPerChar,snd_gordontalk,.9,1]This is my little world.
		pause 1
		slide Gordon -0.1 0
		g [typistSoundPerChar,snd_gordontalk,.9,1]Say, have you seen my clown nose?
		slide Gordon 0 0
		g [typistSoundPerChar,snd_gordontalk,.9,1]I lost it a while ago. Would you find it for me?
		g [typistSoundPerChar,snd_gordontalk,.9,1]Thanks twin.
		textbox false
		";
	}
